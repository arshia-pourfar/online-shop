...
async function main() {
    ...
    const categories = [
        { id: 1, name: "Accessories", slug: "accessories", imageSrc: 'Accessories.png' },
        { id: 2, name: "Display", slug: "display", imageSrc: 'Display.png' },
        { id: 3, name: "Cables", slug: "cables", imageSrc: 'Cables.png' },
        { id: 4, name: "Audio", slug: "audio", imageSrc: 'Audio.png' },
        { id: 5, name: "Camera", slug: "camera", imageSrc: 'Camera.png' },
        { id: 6, name: "Furniture", slug: "furniture", imageSrc: 'Furniture.png' },
        { id: 7, name: "Storage", slug: "storage", imageSrc: 'Storage.png' },
        { id: 8, name: "Wearables", slug: "wearables", imageSrc: 'Wearables.png' },
        { id: 9, name: "Networking", slug: "networking", imageSrc: 'Networking.png' },
        { id: 10, name: "Power", slug: "power", imageSrc: 'Power.png' },
        { id: 11, name: "Lighting", slug: "lighting", imageSrc: 'Lighting.png' },
        { id: 12, name: "Charging", slug: "charging", imageSrc: 'Charging.png' },
    ];
