...
// import { NavigationOptions } from "swiper/types";
// import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
// import { faAngleLeft, faAngleRight, faArrowRotateLeft, faCartShopping, faTruck } from "@fortawesome/free-solid-svg-icons";
// import { faInstagram } from "@fortawesome/free-brands-svg-icons/faInstagram";
// import { faTwitter } from "@fortawesome/free-brands-svg-icons/faTwitter";
// import { faFacebook } from "@fortawesome/free-brands-svg-icons/faFacebook";
// import { useAuth } from "@/lib/context/authContext";
...
//               <div className="group w-full lg:w-2/3 h-full relative rounded-2xl overflow-hidden shadow-lg bg-secondary-bg">
//                 <div className="w-full h-full absolute right-0 z-20 px-3 flex justify-between items-center gap-3 opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:bg-black/15">
//                   <button ref={prevLargePosterRef} className="z-10 bg-secondary-bg text-primary-text text-3xl rounded-full size-14 shadow flex justify-center items-center">
//                     <FontAwesomeIcon icon={faAngleLeft} />
//                   </button>
//                   <button ref={nextLargePosterRef} className="z-10 bg-secondary-bg text-primary-text text-3xl rounded-full size-14 shadow flex justify-center items-center">
...
//                 <div className="group flex-1 rounded-2xl overflow-hidden shadow-md relative bg-secondary-bg">
//                   <div className="w-full h-full absolute right-0 z-20 px-3 flex justify-between items-center gap-3 opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:bg-black/15">
//                     <button ref={prevSmallPosterRef} className="z-10 bg-secondary-bg text-primary-text text-2xl rounded-full size-12 shadow">
//                       <FontAwesomeIcon icon={faAngleLeft} />
//                     </button>
//                     <button ref={nextSmallPosterRef} className="z-10 bg-secondary-bg text-primary-text text-2xl rounded-full size-12 shadow">
//                       <FontAwesomeIcon icon={faAngleRight} />
//                     </button>
//                   </div>
//                   {isLoading ? (
...
//                 <div className="group flex-1 rounded-2xl overflow-hidden shadow-md relative bg-secondary-bg">
//                   <div className="w-full h-full absolute right-0 z-20 px-3 flex justify-between items-center gap-3 opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:bg-black/15">
//                     <button ref={prevSmallPoster2Ref} className="z-10 bg-secondary-bg text-primary-text text-2xl rounded-full size-12 shadow">
//                       <FontAwesomeIcon icon={faAngleLeft} />
//                     </button>
//                     <button ref={nextSmallPoster2Ref} className="z-10 bg-secondary-bg text-primary-text text-2xl rounded-full size-12 shadow">
//                       <FontAwesomeIcon icon={faAngleRight} />
//                     </button>
//                   </div>
//                   {isLoading ? (
...
//               </h2>
//               <div className="absolute right-0 top-0 flex justify-between items-center gap-3">
//                 <button ref={prevProductRef} className="z-10 bg-accent text-primary-text text-2xl rounded-full size-12 shadow">
//                   <FontAwesomeIcon icon={faAngleLeft} />
//                 </button>
//                 <button ref={nextProductRef} className="z-10 bg-accent text-primary-text text-2xl rounded-full size-12 shadow">
//                   <FontAwesomeIcon icon={faAngleRight} />
//                 </button>
//               </div>
//             </div>
